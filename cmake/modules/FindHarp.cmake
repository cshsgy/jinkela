...
macro(__harp_determine_version)
  ...
  if(result GREATER 0)
    message(
      FATAL_ERROR "cannot determine PEP 440 version of Pyharp!")
  endif()
...
if(Python3_Interpreter_FOUND)
  ...
  cmake_path(REPLACE_FILENAME harp_init_file harp OUTPUT_VARIABLE harp_include_dir)
...
set(HARP_INCLUDE_DIR "${HARP_INCLUDE_DIR}" CACHE FILEPATH "Path to a file.")
